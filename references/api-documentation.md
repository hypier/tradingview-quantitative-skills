...
**Token Expiration:**
- Type 1: 30 minutes - For quick testing
- Type 2: 1 day - For daily usage
- Type 3: 15 days - For long-term usage
...
```
wss://ws.tradingviewapi.com?token=YOUR_TOKEN
```
...
**Security Notes:**
- JWT tokens automatically expire based on the `token-jwt-type` selected
